...
import 'package:food_delivery/src/enum/auth_mode.dart';
  ...
  Future<bool> fetchUserInfos() async {
    ...
    try {
      final http.Response response = await http
          .get(Uri.parse("https://foodie2-33792-default-rtdb.firebaseio.com/users.json"));
  ...
  Future<bool> addUserInfo(Map<String, dynamic> userInfo) async {
    ...
    try {
      final http.Response response = await http.post(
          Uri.parse("https://foodie2-33792-default-rtdb.firebaseio.com/users.json"),
    ...
    try {
      ...
      if (authMode == AuthMode.SignUp) {
        response = await http.post(
          Uri.parse("https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBD3_3IEd8EFZnzpQKX5brtUActP2w7L5E"),
          body: json.encode(authData),
          headers: {'Content-Type': 'application/json'},
        );
      } else if (authMode == AuthMode.SignIn) {
        response = await http.post(
          Uri.parse("https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBD3_3IEd8EFZnzpQKX5brtUActP2w7L5E"),
          body: json.encode(authData),
          headers: {'Content-Type': 'application/json'},
        );
      }
      ...
      if (responseBody.containsKey('idToken')) {
        ...
        if (responseBody['error']['message'] == 'INVALID_EMAIL') {
